/system script add name="rename-interfaces" dont-require-permissions=yes source={
    ...
    :while ($waited < $maxWait && $done = false) do={
        ...
        :if ($etherCount >= 26) do={   # Adjust to your port count
            ...
            set [find default-name=ether13] disable-running-check=no name=sfp-sfpplus13
            set [find default-name=ether14] disable-running-check=no name=sfp-sfpplus14
            set [find default-name=ether15] disable-running-check=no name=sfp-sfpplus15
            set [find default-name=ether16] disable-running-check=no name=sfp-sfpplus16
            set [find default-name=ether17] disable-running-check=no name=sfp-sfpplus17
            set [find default-name=ether18] disable-running-check=no name=sfp-sfpplus18
            set [find default-name=ether19] disable-running-check=no name=sfp-sfpplus19
            set [find default-name=ether20] disable-running-check=no name=sfp-sfpplus20
            set [find default-name=ether21] disable-running-check=no name=sfp-sfpplus21
            set [find default-name=ether22] disable-running-check=no name=sfp-sfpplus22
            set [find default-name=ether23] disable-running-check=no name=sfp-sfpplus23
            set [find default-name=ether24] disable-running-check=no name=sfp-sfpplus24
            set [find default-name=ether25] disable-running-check=no name=qsfpplus1-1
            set [find default-name=ether26] disable-running-check=no name=qsfpplus2-1
